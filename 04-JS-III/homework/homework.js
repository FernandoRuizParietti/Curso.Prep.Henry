...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  let num = n.toString() // transformamos el numero en un string 
  if (num.charAt(0)==="9") { // me fijo si el primer caracter del string es ===9
    return true;
  }
  return false;
}
...
function continueStatement(numero) {
  ...
  var suma = numero;
  for(var i= 0; i<10; i++) { 
    if(i === 5) continue; // el continue, pasa al paso siguiente del for (saltea un paso)
    else {
      suma = suma + 2;
      array.push(suma);
    }
